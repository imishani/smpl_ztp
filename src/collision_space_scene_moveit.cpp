...
void CollisionSpaceSceneMoveit::SetCollisionSpace(::moveit_collision_interface* cspace)
{
    if (cspace != m_cspace) {
...
bool CollisionSpaceSceneMoveit::SetRobotState(
        const moveit_msgs::RobotState& robot_state)
{
    ...
    if (!m_cspace->execute()){
        ROS_ERROR("Failed to execute start joint state");
        return false;
    }
...
bool CollisionSpaceSceneMoveit::ProcessCollisionObjectMsg(
...
bool CollisionSpaceSceneMoveit::AddCollisionObjectMsg(
        const moveit_msgs::CollisionObject& object)
{
...
//        auto shape = make_unique1<MeshShape>(
...
bool CollisionSpaceSceneMoveit::RemoveCollisionObjectMsg(
        const moveit_msgs::CollisionObject& object)
{
...
bool CollisionSpaceSceneMoveit::AppendCollisionObjectMsg(
        const moveit_msgs::CollisionObject& object)
{
    auto* _object = FindCollisionObject(object.id);
    if (!_object) {
...
bool CollisionSpaceSceneMoveit::MoveCollisionObjectMsg(
        const moveit_msgs::CollisionObject& object)
{
    auto* _object = FindCollisionObject(object.id);
    if (!_object) {
...
bool CollisionSpaceSceneMoveit::ProcessOctomapMsg(
...
///     false otherwise
bool CollisionSpaceSceneMoveit::ProcessAttachedCollisionObject(
...
bool CollisionSpaceSceneMoveit::UpdatePlanningSceneWorld(
...
bool CollisionSpaceSceneMoveit::UpdatePlanningScene(
...
bool CollisionSpaceSceneMoveit::CheckCollisionObjectSanity(
...
bool CollisionSpaceSceneMoveit::CheckInsertOctomap(
...
auto CollisionSpaceSceneMoveit::FindCollisionObject(const std::string& id) const
-> CollisionObject*
{
